...
def define_G(input_nc, output_nc, ngf, which_model_netG, norm='batch', use_dropout=False, gpu_ids=[], num_down=5):
    netG = None
    ...
    if which_model_netG == 'unet_128':
        netG = UnetGenerator3d(input_nc, output_nc, num_down, ngf, norm_layer=norm_layer, use_dropout=use_dropout, gpu_ids=gpu_ids)
