...
DATASETS = {
    ...
    'mri_encode': {
		'transforms': transforms_config.CropEncodeTransforms,
		'train_source_root': dataset_paths['mri_train'],
		'train_target_root': dataset_paths['mri_train'],
		'test_source_root': dataset_paths['mri_test'],
		'test_target_root': dataset_paths['mri_test'],
	}
}
