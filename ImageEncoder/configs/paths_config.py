dataset_paths = {
	...
	'mri_train': '/home1/yujiali/dataset/brain_MRI/ADNI/T1/aligned_brain_MNI',
    'mri_test': '/home1/yujiali/dataset/test/brain_mni'
}
...
model_paths = {
    ...
    'stylegan_mri': '/home1/yujiali/cf_mri_2/StyleGAN/exp_1/checkpoint/237600.model'
}
