...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--crop_size', type=tuple, default=(192, 224, 192))
        ...
        self.parser.add_argument('--l1_lambda', default=1, type=float, help='L1 loss multiplier factor')
        self.parser.add_argument('--l1_fft_lambda', default=0.1, type=float, help='l1 fft loss multiplier factor')

        self.parser.add_argument('--stylegan_weights', default=model_paths['stylegan_mri'], type=str,
        ...
        # Discriminator flags
        self.parser.add_argument('--w_discriminator_lambda', default=0.005, type=float, help='Dw loss multiplier')
        ...
        self.parser.add_argument('--gpu_id', type=str, default='4')
        self.parser.add_argument('--noise_encoder', action='store_true', default=False)
